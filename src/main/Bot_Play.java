 ...
 * @author 53iky0
 */
public class Bot_Play extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bot_Play.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
