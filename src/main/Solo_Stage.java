 ...
 * @author 53iky0
 */
public class Solo_Stage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        contentLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/level.jpg"))); // NOI18N
        contentLabel.setText("BOT LEVEL");
        contentLabel.setToolTipText("");
        ...
        contentLabel.setBounds(-250, -60, 660, 460);
    ...
    private void newgame(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_newgame
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Solo_Stage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Solo_Stage().setVisible(true);
            }
        });
    }
